...
int compute_UnifiedMem(void)
{
	...
	cudaMallocManaged((void **)&host_a, NUM_ELEM * sizeof(*host_a));
	cudaMallocManaged((void **)&host_b, NUM_ELEM * sizeof(*host_b));
...
int compute_NoUnifiedMem(void)
{
	...
	cudaMalloc((void **)&device_a, NUM_ELEM * sizeof(*device_a));
	cudaMalloc((void **)&device_b, NUM_ELEM * sizeof(*device_b));
